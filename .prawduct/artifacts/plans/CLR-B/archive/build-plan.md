...
archived: 2026-09-08
superseded_by: "chunk 2 shipped as DEV-6M2K; chunk 1 -> #372 (host-kind route dedup), chunk 3 -> #419 (render preflight when audio engine off)"
unbuilt_at_archive: "3 of 3 Status items still unticked (Chunk 01: ENV-5R2J — single source for host-kind→route mapping, Chunk 02: SYN-2M9P — verify current master-load behavior; close the remaining gap or record supersession, Chunk 03: RND-7K3M — render pre-flight: fail fast when the audio engine is off (cumulative-final)) — the scope shipped, but this plan did not finish with it"
maintained: false
---

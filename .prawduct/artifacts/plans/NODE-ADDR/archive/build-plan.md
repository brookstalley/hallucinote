...
lifecycle: completed
archived: 2026-09-08
unbuilt_at_archive: "9 of 31 Status items still unticked (Chunk A: addressing foundation [FLIP] — ✅ DONE + LIVE-VERIFIED 6/6 2026-06-15 (merged to develop):, Chunk B: params read-side durability — ✅ CODE DONE + GREEN 2026-06-15 (full suite green; Live operator-verify pending):, **Operator (Live) — pending** (enqueued in operator-verification.md): swell `21 Voice Lead`, …) — the scope shipped, but this plan did not finish with it"
maintained: false
---
...
- [ ] Chunk B: params read-side durability — ✅ CODE DONE + GREEN 2026-06-15 (full suite green; Live operator-verify pending):
  ...
  - [x] **§4 corrections** — deleted the false "Python can't call MCP tools" claims (`capture.py` module +
    ...
    (backlog DEV-7K4H/DEV-9K7N: addressing shipped, acquisition was the gap)

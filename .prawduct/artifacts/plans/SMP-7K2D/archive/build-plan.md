...
unbuilt_at_archive: 4 of 6 Status items still unticked (**0 — Capability probe** (Live; gates 3, 4) — sample-assignment mechanism + window/reverse co-expressibility, **3 — Sample-instrument push** (Live; gated on 0), **4 — Reverse push** (Live; gated on 0), …) — the scope shipped, but this plan did not finish with it
maintained: false
---

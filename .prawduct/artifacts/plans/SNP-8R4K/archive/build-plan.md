...
archived: 2026-09-08
superseded_by: "brookstalley/hallucinote#373 (capture records the HallucinoteAnalyzer devices)"
unbuilt_at_archive: 1 of 4 Status items still unticked (**2 — Snapshot-file cleanup + version stamp** (no-Live; State-1 clean-at-rest)) — the scope shipped, but this plan did not finish with it
maintained: false
---

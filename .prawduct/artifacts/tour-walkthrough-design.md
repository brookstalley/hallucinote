...
discovery (precedence step 3 of the root contract's resolution rules) walks up from
the song directory and finds it, and per-branch DB naming probes the containing
repo's branch as usual.

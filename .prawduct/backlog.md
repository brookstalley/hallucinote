...
<!-- C8c (polymeter cycle-length + additive/grouping decode) SHIPPED 2026-05-29
on feature/polymeter-grouping-c8c: per-onset peak-amplitude accent in onsets.py,
additive-grouping decoder + polymeter accent-autocorrelation detector in
cross_rhythm.py, PartCrossRhythm.grouping/cycle_length_beats + Polymeter on
SectionMetrics, /mix-review + docs §5 updated. Validated end-to-end through a
real Live render (additive (3,3,2) conf 1.00; polymeter 4&3 realign 12).
docs/polyrhythms.md §5 limits #1/#2 are now decoded. -->

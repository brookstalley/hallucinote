...
and read as a hang (``bug report "`push execute` stalls for minutes at the `devices` phase — re-applies ALL device params (1243 calls) on a set whose params were just captured"``).

...
def to_live_bpm(
    ...
    ``pulse_kind`` accepts plain + dotted + triplet variants of whole / half
    / quarter / eighth / sixteenth. Unknown values raise ``ValueError``
    listing the accepted set — that's the canonical source so docs don't
    drift.
